...
export const Pokemon = () => {
  ...
  const [descriptionMoves, setDescriptionMoves] = useState<
    dercriptionMovesType[]
  >([]);
  const [aboutPokemon, setAboutPokemon] = useState<AboutPokemonype>(
    {} as AboutPokemonype
  );

  const totalStats = state.stats.reduce(
    (accmulator, currenValue) => accmulator + currenValue.base_stat,
    0
  );

  const getFlavorsTexts = async (url: string) => {
    const aboutPokemon = await fetch(url).then((result) => result.json());
      ...
      <S.Container>
        <S.Content type={state.pokemonTypes[0].type.name}>
          <S.Padding>
            ...
            <S.TypeContainer>
              {state.pokemonTypes.map((type) => (
                <S.TypeSpan
                  key={type.type.name}
                  type={state.pokemonTypes[0].type.name}
                >
                  {type.type.name}
                </S.TypeSpan>
              ))}
          ...
          <S.PokemonInfo>
            <S.TabContainer>
              <S.TabHeader>
                <S.TabHeaderTitle onClick={() => setTab(1)} active={tab == 1}>
                  About
                </S.TabHeaderTitle>
                <S.TabHeaderTitle onClick={() => setTab(2)} active={tab == 2}>
                  Base Stats
                </S.TabHeaderTitle>
                <S.TabHeaderTitle onClick={() => setTab(3)} active={tab == 3}>
                  Evolution
                </S.TabHeaderTitle>
                <S.TabHeaderTitle onClick={() => setTab(4)} active={tab == 4}>
                  Moves
                </S.TabHeaderTitle>
              </S.TabHeader>

              <S.TabContent active={tab == 1}>
                {aboutPokemon.flavor_text_entries ? (
                  <AboutCard
                    type={state.pokemonTypes[0].type.name}
                    text={`${aboutPokemon?.flavor_text_entries[0]?.flavor_text}`}
                  />
                ) : (
                  <AboutCard type={state.pokemonTypes[0].type.name} text="" />
                )}
                ...
                <S.TabRow columns={2}>
                  ...
                  <S.TabText>
                    {aboutPokemon?.evolves_from_species?.name ?? "Nobody"}
                  </S.TabText>
                </S.TabRow>
                <S.TabRow columns={2}>
              ...
              <S.TabContent active={tab == 2}>
                <S.TabRow columns={3}>
                  ...
                  <ProgressBar
                    maxValue={200}
                    currentValue={state.stats[0].base_stat}
                  />
                </S.TabRow>
                <S.TabRow columns={3}>
                  ...
                  <ProgressBar
                    maxValue={200}
                    currentValue={state.stats[1].base_stat}
                  />
                </S.TabRow>
                <S.TabRow columns={3}>
                  ...
                  <ProgressBar
                    maxValue={200}
                    currentValue={state.stats[2].base_stat}
                  />
                </S.TabRow>
                <S.TabRow columns={3}>
                  ...
                  <ProgressBar
                    maxValue={200}
                    currentValue={state.stats[3].base_stat}
                  />
                </S.TabRow>
                <S.TabRow columns={3}>
                  ...
                  <ProgressBar
                    maxValue={200}
                    currentValue={state.stats[4].base_stat}
                  />
                </S.TabRow>
                <S.TabRow columns={3}>
                  ...
                  <ProgressBar
                    maxValue={200}
                    currentValue={state.stats[5].base_stat}
                  />
                </S.TabRow>
                <S.TabRow columns={3}>
              ...
              <S.TabContent active={tab == 3}>Comming soon...</S.TabContent>
                ...
                {state.moves.map((move, index) => {
                  return (
                    <S.TabRow key={move.move.name} columns={2}>
                      ...
                      <S.TabText>
                        {
                          descriptionMoves[index]?.flavor_text_entries[0]
                            ?.flavor_text
                        }
                      </S.TabText>
                    </S.TabRow>
